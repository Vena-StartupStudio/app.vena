...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 flex flex-col">
      <header className="relative flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 dark:border-slate-700 dark:bg-slate-800 flex-shrink-0">
        <img src="/favicon.png" alt="Vena Logo" className="h-8 w-8" />
        <h1 className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-xl font-bold text-slate-900 dark:text-white">
          Vena
        </h1>
